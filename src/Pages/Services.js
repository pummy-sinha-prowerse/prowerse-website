...
function Service() {
        ...
        <div className="container" data-aos="zoom-out" data-aos-delay="100">
          <div className="row">
            <div className="col-xl-6">
              ...
              <br/>
              <h5> Whether it's troubleshooting challenges or
                envisioning future enhancements, we're your partners in
                navigating the ever-evolving landscape of technology.</h5>
  ...
  {/* <!-- ======= Service Section ======= --> */}
      ...
      {/* <!-- ======= Services Section ======= --> */}
      <section id="services" className="services " style={{padding:'0px 0px'}}>
        <div className="container" data-aos="fade-up">
